  ...
  implements Configuration, Serializable
{
  ...
  {
    if ("https://api.twitter.com/1.1/".equals(fixURL(false, this.restBaseURL)))
      this.restBaseURL = fixURL(this.useSSL, this.restBaseURL);
    if ("https://api.twitter.com/oauth/access_token".equals(fixURL(false, this.oAuthAccessTokenURL)))
      this.oAuthAccessTokenURL = fixURL(this.useSSL, this.oAuthAccessTokenURL);
    if ("https://api.twitter.com/oauth/authenticate".equals(fixURL(false, this.oAuthAuthenticationURL)))
      this.oAuthAuthenticationURL = fixURL(this.useSSL, this.oAuthAuthenticationURL);
    if ("https://api.twitter.com/oauth/authorize".equals(fixURL(false, this.oAuthAuthorizationURL)))
      this.oAuthAuthorizationURL = fixURL(this.useSSL, this.oAuthAuthorizationURL);
    if ("https://api.twitter.com/oauth/request_token".equals(fixURL(false, this.oAuthRequestTokenURL)))
