  ...
  implements Serializable
{
  ...
  static
  {
    ...
    //   6: putstatic 44	twitter4j/VineTwitterFactory:DEFAULT_AUTHORIZATION	Ltwitter4j/auth/Authorization;
    ...
    //   61: astore 4
    //   63: aload 4
    //   65: putstatic 68	twitter4j/VineTwitterFactory:TWITTER_CONSTRUCTOR	Ljava/lang/reflect/Constructor;
    //   68: getstatic 68	twitter4j/VineTwitterFactory:TWITTER_CONSTRUCTOR	Ljava/lang/reflect/Constructor;
    //   71: astore 8
    //   73: iconst_2
    ...
    //   86: aload 9
    //   88: iconst_1
    //   89: getstatic 44	twitter4j/VineTwitterFactory:DEFAULT_AUTHORIZATION	Ltwitter4j/auth/Authorization;
    //   92: aastore
    //   93: aload 8
    //   95: aload 9
    ...
    //   103: putstatic 78	twitter4j/VineTwitterFactory:SINGLETON	Ltwitter4j/Twitter;
    //   106: return
    //   107: astore_3
  ...
  public VineTwitterFactory(String paramString)
  {
    this(ConfigurationContext.getInstance(paramString));
  }

  public VineTwitterFactory(Configuration paramConfiguration)
  {
 ...
 * Qualified Name:     twitter4j.VineTwitterFactory
