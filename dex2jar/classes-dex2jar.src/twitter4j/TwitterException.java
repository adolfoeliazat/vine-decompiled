  ...
  implements TwitterResponse, HttpResponseCode
{
  ...
  public String toString()
  {
    ...
    label171: for (String str2 = ""; ; str2 = "exceptionCode=[" + getExceptionCode() + "], ")
    {
      return str2 + "statusCode=" + this.statusCode + ", message=" + this.errorMessage + ", code=" + this.errorCode + ", retryAfter=" + getRetryAfter() + ", version=" + Version.getVersion() + '}';
