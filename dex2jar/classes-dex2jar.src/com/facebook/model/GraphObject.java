  ...
  public static final class Factory
  {
    ...
    public static boolean hasSameId(GraphObject paramGraphObject1, GraphObject paramGraphObject2)
    {
      ...
      do
      {
        do
          return bool;
        while (paramGraphObject1.equals(paramGraphObject2));
        localObject1 = paramGraphObject1.getProperty("id");
        localObject2 = paramGraphObject2.getProperty("id");
      }
      while ((localObject1 != null) && (localObject2 != null) && ((localObject1 instanceof String)) && ((localObject2 instanceof String)) && (localObject1.equals(localObject2)));
      return false;
    }
