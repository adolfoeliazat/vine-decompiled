...
public class Response
{
    ...
    throws JSONException
  {
    ...
    if (paramObject1 == JSONObject.NULL)
      return new Response(paramRequest, paramHttpURLConnection, (GraphObject)null, paramBoolean);
    ...
    throws FacebookException, JSONException
  {
    ...
    try
    {
      ...
      for (int k = paramHttpURLConnection.getResponseCode(); ; k = 200)
      {
  ...
  public Request getRequestForPagedResults(PagingDirection paramPagingDirection)
  {
    ...
    label64: for (str = localPagingInfo.getNext(); Utility.isNullOrEmpty(str); str = localPagingInfo.getPrevious())
      return null;
