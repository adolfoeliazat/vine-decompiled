...
public abstract interface dl extends IInterface
{
  public abstract void a(float paramFloat1, float paramFloat2)
    throws RemoteException;

  public abstract boolean a(dl paramdl)
    throws RemoteException;
  ...
  public static abstract class a extends Binder
    implements dl
  {
    public static dl L(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 19:
        paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
        boolean bool1 = a(L(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        int j = 0;
        if (bool1)
          j = 1;
      ...
      implements dl
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          localParcel1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
          if (paramdl != null);
          for (IBinder localIBinder = paramdl.asBinder(); ; localIBinder = null)
          {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          {
            LatLngBounds localLatLngBounds2 = LatLngBounds.CREATOR.createFromParcel(localParcel2);
