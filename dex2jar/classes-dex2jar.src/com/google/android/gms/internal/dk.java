...
public abstract interface dk extends IInterface
{
  public abstract boolean a(dk paramdk)
  ...
  public static abstract class a extends Binder
    implements dk
  {
    public static dk K(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof dk)))
        return (dk)localIInterface;
      ...
      throws RemoteException
    {
      ...
      case 17:
        paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
        boolean bool1 = a(K(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        int j = 0;
        if (bool1)
          j = 1;
      ...
      implements dk
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          if (paramdk != null);
          for (IBinder localIBinder = paramdk.asBinder(); ; localIBinder = null)
          {
