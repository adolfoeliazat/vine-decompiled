...
{
  public abstract boolean a(dn paramdn)
  ...
  public static abstract class a extends Binder
    implements dn
  {
    public static dn N(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 19:
        paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
        boolean bool1 = a(N(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        int j = 0;
        if (bool1)
          j = 1;
      ...
      implements dn
    {
        ...
        throws RemoteException
      {
        ...
        try
        {
          ...
          if (paramdn != null);
          for (IBinder localIBinder = paramdn.asBinder(); ; localIBinder = null)
          {
