...
final class ci
{
  ...
  public final byte[] getBytes()
  {
    ...
    //   17: aload_2
    //   18: aload_0
    //   19: getfield 21	com/flurry/android/ci:dO	I
    //   22: invokevirtual 49	java/io/DataOutputStream:writeShort	(I)V
    //   25: aload_2
    //   26: aload_0
    //   27: getfield 23	com/flurry/android/ci:ex	J
    //   30: invokevirtual 53	java/io/DataOutputStream:writeLong	(J)V
    //   33: aload_2
    //   34: aload_0
    //   35: getfield 25	com/flurry/android/ci:ey	Ljava/lang/String;
    //   38: invokevirtual 57	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   41: aload_2
    //   42: aload_0
    //   43: getfield 27	com/flurry/android/ci:ez	Ljava/lang/String;
    //   46: invokevirtual 57	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   49: aload_2
    //   50: aload_0
    //   51: getfield 29	com/flurry/android/ci:eA	Ljava/lang/String;
    //   54: invokevirtual 57	java/io/DataOutputStream:writeUTF	(Ljava/lang/String;)V
    //   57: aload_0
    //   58: getfield 31	com/flurry/android/ci:eB	Ljava/lang/Throwable;
    //   61: ifnull +229 -> 290
    //   64: aload_0
    //   65: getfield 25	com/flurry/android/ci:ey	Ljava/lang/String;
    //   68: ldc 59
    //   70: if_acmpne +80 -> 150
    //   73: aload_2
    //   74: iconst_3
    ...
    //   99: astore 8
    //   101: aload_0
    //   102: getfield 31	com/flurry/android/ci:eB	Ljava/lang/Throwable;
    ...
    //   163: astore 5
    //   165: aload_2
    //   166: invokestatic 95	com/flurry/android/bd:a	(Ljava/io/Closeable;)V
    //   169: aload 5
    //   171: areturn
    //   172: aload_0
    //   173: getfield 31	com/flurry/android/ci:eB	Ljava/lang/Throwable;
    //   176: invokevirtual 99	java/lang/Throwable:getCause	()Ljava/lang/Throwable;
    //   179: ifnull +71 -> 250
    //   182: aload 7
    //   184: aload 8
    ...
    //   197: pop
    //   198: aload_0
    //   199: getfield 31	com/flurry/android/ci:eB	Ljava/lang/Throwable;
    //   202: invokevirtual 99	java/lang/Throwable:getCause	()Ljava/lang/Throwable;
    ...
    //   255: invokevirtual 108	java/lang/String:getBytes	()[B
    //   258: astore 14
    //   260: aload_2
    //   261: aload 14
    //   263: arraylength
    //   264: invokevirtual 111	java/io/DataOutputStream:writeInt	(I)V
    //   267: aload_2
    //   268: aload 14
    //   270: invokevirtual 115	java/io/DataOutputStream:write	([B)V
    //   273: aload_2
    //   274: invokevirtual 118	java/io/DataOutputStream:flush	()V
    //   277: aload_1
    //   278: invokevirtual 121	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   281: astore 6
    //   283: aload_2
    //   284: invokestatic 95	com/flurry/android/bd:a	(Ljava/io/Closeable;)V
    //   287: aload 6
    //   289: areturn
    //   290: aload_2
    //   291: iconst_1
    ...
    //   303: astore_3
    //   304: aload_2
    //   305: invokestatic 95	com/flurry/android/bd:a	(Ljava/io/Closeable;)V
    //   308: aload_3
    //   309: athrow
    //   310: astore 23
    //   312: aload 23
 ...
 * Qualified Name:     com.flurry.android.ci
