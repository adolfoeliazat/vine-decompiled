  ...
  implements Parser.ActionHandler
{
  ...
  {
    this.parser.advance(Symbol.ARRAY_START);
    for (long l1 = this.in.skipArray(); l1 != 0L; l1 = this.in.skipArray())
    {
      long l3;
  ...
  {
    this.parser.advance(Symbol.MAP_START);
    for (long l1 = this.in.skipMap(); l1 != 0L; l1 = this.in.skipMap())
    {
      long l3;
      for (long l2 = l1; ; l2 = l3)
      {
 ...
 * Qualified Name:     com.flurry.org.apache.avro.io.ValidatingDecoder
