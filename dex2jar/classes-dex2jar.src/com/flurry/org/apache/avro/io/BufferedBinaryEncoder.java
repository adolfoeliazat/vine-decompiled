...
public class BufferedBinaryEncoder extends BinaryEncoder
{
  ...
  BufferedBinaryEncoder configure(OutputStream paramOutputStream, int paramInt)
  {
    ...
    {
      throw new AvroRuntimeException("Failure flushing old output", localIOException);
    }
  }
  ...
  static class OutputStreamSink extends BufferedBinaryEncoder.ByteSink
  {
 ...
 * Qualified Name:     com.flurry.org.apache.avro.io.BufferedBinaryEncoder
