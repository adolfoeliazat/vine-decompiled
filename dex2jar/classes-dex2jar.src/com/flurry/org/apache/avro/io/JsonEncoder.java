  ...
  implements Parser.ActionHandler
{
    ...
    throws IOException
  {
    ...
    JsonGenerator localJsonGenerator = new JsonFactory().createJsonGenerator(paramOutputStream, JsonEncoding.UTF8);
    ...
    localJsonGenerator.setPrettyPrinter(localMinimalPrettyPrinter);
    ...
    throws IOException
  {
    ...
    {
      Symbol.FieldAdjustAction localFieldAdjustAction = (Symbol.FieldAdjustAction)paramSymbol2;
      this.out.writeFieldName(localFieldAdjustAction.fname);
    }
    do
      while (true)
      {
 ...
 * Qualified Name:     com.flurry.org.apache.avro.io.JsonEncoder
