  ...
  implements Parser.ActionHandler
{
    ...
    throws IOException
  {
    ...
    switch (2.$SwitchMap$org$codehaus$jackson$JsonToken[localJsonToken.ordinal()])
    {
    default:
    case 1:
    case 2:
    ...
    return new JsonParser()
    {
        ...
        throws IOException
      {
        ...
        while (true)
        {
          ...
          int j = this.pos;
          this.pos = (j + 1);
          switch (arrayOfInt[((JsonDecoder.JsonElement)localList.get(j)).token.ordinal()])
          {
          default:
          case 1:
          case 2:
  ...
  public Symbol doAction(Symbol paramSymbol1, Symbol paramSymbol2)
    throws IOException
  {
    Symbol.FieldAdjustAction localFieldAdjustAction;
    String str2;
    if ((paramSymbol2 instanceof Symbol.FieldAdjustAction))
    {
      localFieldAdjustAction = (Symbol.FieldAdjustAction)paramSymbol2;
      str2 = localFieldAdjustAction.fname;
      if (this.currentReorderBuffer != null)
      {
        List localList = (List)this.currentReorderBuffer.savedFields.get(str2);
        if (localList != null)
        {
          this.currentReorderBuffer.savedFields.remove(str2);
          this.currentReorderBuffer.origParser = this.in;
          this.in = makeParser(localList);
        }
      }
    }
    do
    {
      do
      {
        ...
        do
        {
          String str3 = this.in.getText();
          this.in.nextToken();
          if (str2.equals(str3))
            break;
          if (this.currentReorderBuffer == null)
            this.currentReorderBuffer = new ReorderBuffer(null);
          this.currentReorderBuffer.savedFields.put(str3, getVaueAsTree(this.in));
        }
        while (this.in.getCurrentToken() == JsonToken.FIELD_NAME);
        throw new AvroTypeException("Expected field name not found: " + localFieldAdjustAction.fname);
    ...
    for (String str1 = "record-end"; ; str1 = "union-end")
      throw error(str1);
    label455: throw new AvroTypeException("Unknown action symbol " + paramSymbol2);
  }
    ...
    throws IOException
  {
    ...
    label138: this.parser.pushSymbol(localAlternative.getSymbol(i));
    return i;
  }
 ...
 * Qualified Name:     com.flurry.org.apache.avro.io.JsonDecoder
