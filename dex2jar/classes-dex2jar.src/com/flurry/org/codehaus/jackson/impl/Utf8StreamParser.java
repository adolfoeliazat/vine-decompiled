...
public final class Utf8StreamParser extends JsonParserBase
{
  ...
  private final void _isNextTokenNameNo(int paramInt)
    throws IOException, JsonParseException
  {
    Name localName = _parseFieldName(paramInt);
    ...
    throws IOException, JsonParseException
  {
    ...
    if (j == 58)
    {
      if (this._inputPtr < this._inputEnd)
      {
        int i3 = 0xFF & this._inputBuffer[this._inputPtr];
        if ((i3 > 32) && (i3 != 47))
        {
          this._inputPtr = (1 + this._inputPtr);
          return i3;
    ...
    else
    {
      ...
      default:
        ...
        if (n != 58)
          _reportUnexpectedChar(n, "was expecting a colon to separate field name and value");
        break;
      case 9:
      case 13:
      case 32:
    ...
    label375: throw _constructError("Unexpected end-of-input within/between " + this._parsingContext.getTypeDesc() + " entries");
  }
    ...
    throws IOException, JsonParseException
  {
    ...
    if (i == 34)
    {
      ...
      if (j + this._inputPtr < this._inputEnd)
      {
        k = j + this._inputPtr;
    ...
    while (true)
    {
      ...
      if (arrayOfByte[m] != this._inputBuffer[(n + m)])
      {
 ...
 * Qualified Name:     com.flurry.org.codehaus.jackson.impl.Utf8StreamParser
