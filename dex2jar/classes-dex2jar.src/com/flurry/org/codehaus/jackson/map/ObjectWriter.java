  ...
  implements Versioned
{
    ...
    throws IOException, JsonGenerationException, JsonMappingException
  {
    ...
    //   4: astore 4
    //   6: aload_0
    //   7: getfield 49	com/flurry/org/codehaus/jackson/map/ObjectWriter:_rootType	Lcom/flurry/org/codehaus/jackson/type/JavaType;
    //   10: ifnonnull +75 -> 85
    //   13: aload_0
    //   14: getfield 41	com/flurry/org/codehaus/jackson/map/ObjectWriter:_provider	Lcom/flurry/org/codehaus/jackson/map/SerializerProvider;
    //   17: aload_3
    //   18: aload_1
    //   19: aload_2
    //   20: aload_0
    //   21: getfield 44	com/flurry/org/codehaus/jackson/map/ObjectWriter:_serializerFactory	Lcom/flurry/org/codehaus/jackson/map/SerializerFactory;
    //   24: invokevirtual 73	com/flurry/org/codehaus/jackson/map/SerializerProvider:serializeValue	(Lcom/flurry/org/codehaus/jackson/map/SerializationConfig;Lcom/flurry/org/codehaus/jackson/JsonGenerator;Ljava/lang/Object;Lcom/flurry/org/codehaus/jackson/map/SerializerFactory;)V
    //   27: aload_0
    //   28: getfield 53	com/flurry/org/codehaus/jackson/map/ObjectWriter:_schema	Lcom/flurry/org/codehaus/jackson/FormatSchema;
    //   31: ifnull +11 -> 42
    //   34: aload_1
    //   35: aload_0
    //   36: getfield 53	com/flurry/org/codehaus/jackson/map/ObjectWriter:_schema	Lcom/flurry/org/codehaus/jackson/FormatSchema;
    //   39: invokevirtual 79	com/flurry/org/codehaus/jackson/JsonGenerator:setSchema	(Lcom/flurry/org/codehaus/jackson/FormatSchema;)V
    //   42: aload_1
    //   43: astore 11
    //   45: aconst_null
    //   46: astore_1
    //   47: aload 11
    //   49: invokevirtual 82	com/flurry/org/codehaus/jackson/JsonGenerator:close	()V
    //   52: aload 4
    //   54: astore 12
    //   56: aconst_null
    //   57: astore 4
    ...
    //   67: ifeq +7 -> 74
    //   70: aconst_null
    //   71: invokevirtual 82	com/flurry/org/codehaus/jackson/JsonGenerator:close	()V
    //   74: iconst_0
    //   75: ifeq +9 -> 84
    //   78: aconst_null
    ...
    //   84: return
    //   85: aload_0
    //   86: getfield 41	com/flurry/org/codehaus/jackson/map/ObjectWriter:_provider	Lcom/flurry/org/codehaus/jackson/map/SerializerProvider;
    //   89: astore 8
    //   91: aload_0
    //   92: getfield 49	com/flurry/org/codehaus/jackson/map/ObjectWriter:_rootType	Lcom/flurry/org/codehaus/jackson/type/JavaType;
    //   95: astore 9
    //   97: aload_0
    //   98: getfield 44	com/flurry/org/codehaus/jackson/map/ObjectWriter:_serializerFactory	Lcom/flurry/org/codehaus/jackson/map/SerializerFactory;
    //   101: astore 10
    //   103: aload 8
    //   105: aload_3
    //   106: aload_1
    ...
    //   108: aload 9
    //   110: aload 10
    //   112: invokevirtual 86	com/flurry/org/codehaus/jackson/map/SerializerProvider:serializeValue	(Lcom/flurry/org/codehaus/jackson/map/SerializationConfig;Lcom/flurry/org/codehaus/jackson/JsonGenerator;Ljava/lang/Object;Lcom/flurry/org/codehaus/jackson/type/JavaType;Lcom/flurry/org/codehaus/jackson/map/SerializerFactory;)V
    //   115: goto -88 -> 27
    //   118: astore 5
    //   120: aload_1
    //   121: ifnull +7 -> 128
    //   124: aload_1
    //   125: invokevirtual 82	com/flurry/org/codehaus/jackson/JsonGenerator:close	()V
    //   128: aload 4
    //   130: ifnull +10 -> 140
    //   133: aload 4
    ...
    throws IOException, JsonGenerationException, JsonMappingException
  {
    ...
    //   24: invokevirtual 73	com/flurry/org/codehaus/jackson/map/SerializerProvider:serializeValue	(Lcom/flurry/org/codehaus/jackson/map/SerializationConfig;Lcom/flurry/org/codehaus/jackson/JsonGenerator;Ljava/lang/Object;Lcom/flurry/org/codehaus/jackson/map/SerializerFactory;)V
    //   27: aload_0
    //   28: getfield 34	com/flurry/org/codehaus/jackson/map/ObjectWriter:_config	Lcom/flurry/org/codehaus/jackson/map/SerializationConfig;
    //   31: getstatic 93	com/flurry/org/codehaus/jackson/map/SerializationConfig$Feature:FLUSH_AFTER_WRITE_VALUE	Lcom/flurry/org/codehaus/jackson/map/SerializationConfig$Feature;
    //   34: invokevirtual 99	com/flurry/org/codehaus/jackson/map/SerializationConfig:isEnabled	(Lcom/flurry/org/codehaus/jackson/map/SerializationConfig$Feature;)Z
    //   37: ifeq +7 -> 44
    //   40: aload_1
    //   41: invokevirtual 102	com/flurry/org/codehaus/jackson/JsonGenerator:flush	()V
    //   44: aload 4
    //   46: astore 7
    //   48: aconst_null
    //   49: astore 4
    ...
    //   68: return
    //   69: aload_0
    //   70: getfield 41	com/flurry/org/codehaus/jackson/map/ObjectWriter:_provider	Lcom/flurry/org/codehaus/jackson/map/SerializerProvider;
    //   73: aload_3
    //   74: aload_1
    //   75: aload_2
    //   76: aload_0
    //   77: getfield 49	com/flurry/org/codehaus/jackson/map/ObjectWriter:_rootType	Lcom/flurry/org/codehaus/jackson/type/JavaType;
    //   80: aload_0
    //   81: getfield 44	com/flurry/org/codehaus/jackson/map/ObjectWriter:_serializerFactory	Lcom/flurry/org/codehaus/jackson/map/SerializerFactory;
    //   84: invokevirtual 86	com/flurry/org/codehaus/jackson/map/SerializerProvider:serializeValue	(Lcom/flurry/org/codehaus/jackson/map/SerializationConfig;Lcom/flurry/org/codehaus/jackson/JsonGenerator;Ljava/lang/Object;Lcom/flurry/org/codehaus/jackson/type/JavaType;Lcom/flurry/org/codehaus/jackson/map/SerializerFactory;)V
    //   87: goto -60 -> 27
    //   90: astore 5
    //   92: aload 4
    //   94: ifnull +10 -> 104
 ...
 * Qualified Name:     com.flurry.org.codehaus.jackson.map.ObjectWriter
