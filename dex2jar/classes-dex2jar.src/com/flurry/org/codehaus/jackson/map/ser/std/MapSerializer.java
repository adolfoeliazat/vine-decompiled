    ...
    throws IOException, JsonGenerationException
  {
    ...
    if (localJsonSerializer2 == null)
      if (!this._valueType.hasGenericTypes())
        break label271;
    label269: label271: for (localJsonSerializer2 = _findAndAddDynamic(localPropertySerializerMap, paramSerializerProvider.constructSpecializedType(this._valueType, localClass), paramSerializerProvider); ; localJsonSerializer2 = _findAndAddDynamic(localPropertySerializerMap, localClass, paramSerializerProvider))
    {
      while (true)
      {
        localPropertySerializerMap = this._dynamicValueSerializers;
 ...
 * Qualified Name:     com.flurry.org.codehaus.jackson.map.ser.std.MapSerializer
