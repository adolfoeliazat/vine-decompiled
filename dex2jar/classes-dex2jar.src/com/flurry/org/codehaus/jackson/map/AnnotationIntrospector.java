...
public abstract class AnnotationIntrospector
{
  ...
  public static class Pair extends AnnotationIntrospector
  {
    ...
    public Boolean shouldUnwrapProperty(AnnotatedMember paramAnnotatedMember)
    {
      Boolean localBoolean = this._primary.shouldUnwrapProperty(paramAnnotatedMember);
      if (localBoolean == null)
        localBoolean = this._secondary.shouldUnwrapProperty(paramAnnotatedMember);
      return localBoolean;
    }
  }
 ...
 * Qualified Name:     com.flurry.org.codehaus.jackson.map.AnnotationIntrospector
