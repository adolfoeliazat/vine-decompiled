  ...
  implements Flushable
{
  ...
  private p(OutputStream paramOutputStream, byte[] paramArrayOfByte)
  {
  ...
  {
    return c(ax.a(paramInt, 0));
  }

  public static p a(OutputStream paramOutputStream)
  {
    return new p(paramOutputStream, new byte[4096]);
  }
  ...
  {
    return a(paramInt) + (c(paramk.a()) + paramk.a());
  }
    ...
    throws IOException
  {
    ...
    if (this.b - this.c >= i)
    {
      paramk.a(this.a, 0, this.c, i);
      this.c = (i + this.c);
      return;
    }
    int j = this.b - this.c;
    paramk.a(this.a, 0, this.c, j);
    int k = j + 0;
    int m = i - j;
    this.c = this.b;
    a();
    if (m <= this.b)
    {
      paramk.a(this.a, k, 0, m);
      this.c = m;
      return;
    }
    InputStream localInputStream = paramk.b();
