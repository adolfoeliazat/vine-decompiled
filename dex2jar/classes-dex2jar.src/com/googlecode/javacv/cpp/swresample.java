...
@Properties(inherit={"Lcom/googlecode/javacv/cpp/avutil;"}, value={@com.googlecode.javacpp.annotation.Platform(cinclude={"<libswresample/swresample.h>"}, link={"swresample@.0"}), @com.googlecode.javacpp.annotation.Platform(preload={"swresample-0"}, value={"windows"})})
public class swresample
{
  ...
  public static native int swr_convert(SwrContext paramSwrContext, @ByPtrPtr @Cast({"uint8_t**"}) ByteBuffer paramByteBuffer1, int paramInt1, @ByPtrPtr @Cast({"const uint8_t**"}) ByteBuffer paramByteBuffer2, int paramInt2);

  public static native int swr_convert(SwrContext paramSwrContext, @ByPtrPtr @Cast({"uint8_t**"}) byte[] paramArrayOfByte1, int paramInt1, @ByPtrPtr @Cast({"const uint8_t**"}) byte[] paramArrayOfByte2, int paramInt2);
