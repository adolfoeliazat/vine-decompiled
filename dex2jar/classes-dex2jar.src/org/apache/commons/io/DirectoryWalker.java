...
public abstract class DirectoryWalker<T>
{
  ...
  protected DirectoryWalker(IOFileFilter paramIOFileFilter1, IOFileFilter paramIOFileFilter2, int paramInt)
  {
    ...
    if (paramIOFileFilter1 != null)
      label27: if (paramIOFileFilter2 == null)
        break label66;
    while (true)
    {
      ...
      break label27;
      label66: paramIOFileFilter2 = TrueFileFilter.TRUE;
    }
  }
    ...
    throws IOException
  {
    ...
    File[] arrayOfFile2;
    label103: for (File[] arrayOfFile1 = paramFile.listFiles(); ; arrayOfFile1 = paramFile.listFiles(this.filter))
    {
    ...
    while (true)
    {
      ...
      break label124;
      break;
      label161: checkIfCancelled(localFile, i, paramCollection);
