...
public class XmlStreamReader extends Reader
{
  ...
  static String getContentTypeEncoding(String paramString)
  {
    ...
    label69: for (String str3 = localMatcher.group(1); str3 != null; str3 = null)
    {
  ...
  static String getContentTypeMime(String paramString)
  {
    ...
    label31: for (String str2 = paramString.substring(0, i); ; str2 = paramString)
    {
      str1 = str2.trim();
      return str1;
    }
    ...
    throws IOException
  {
    ...
    label282: throw new XmlStreamReaderException(MessageFormat.format("Invalid encoding, BOM [{0}] XML guess [{1}] XML prolog [{2}] encoding mismatch", new Object[] { paramString1, paramString2, paramString3 }), paramString1, paramString2, paramString3);
    label397: throw new XmlStreamReaderException(MessageFormat.format("Invalid encoding, BOM [{0}] XML guess [{1}] XML prolog [{2}] unknown BOM", new Object[] { paramString1, paramString2, paramString3 }), paramString1, paramString2, paramString3);
  }
