  ...
  implements Serializable
{
  ...
  public ByteOrderMark(String paramString, int[] paramArrayOfInt)
  {
    ...
    this.bytes = new int[paramArrayOfInt.length];
    System.arraycopy(paramArrayOfInt, 0, this.bytes, 0, paramArrayOfInt.length);
  }
