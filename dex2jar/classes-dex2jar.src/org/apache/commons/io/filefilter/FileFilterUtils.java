...
public class FileFilterUtils
{
  ...
  private static final IOFileFilter svnFilter = notFileFilter(and(arrayOfIOFileFilter2));
  ...
  public static IOFileFilter and(IOFileFilter[] paramArrayOfIOFileFilter)
  {
    return new AndFileFilter(toList(paramArrayOfIOFileFilter));
  }
  ...
  public static File[] filter(IOFileFilter paramIOFileFilter, File[] paramArrayOfFile)
  {
    if (paramIOFileFilter == null)
      throw new IllegalArgumentException("file filter is null");
  ...
  public static List<File> filterList(IOFileFilter paramIOFileFilter, File[] paramArrayOfFile)
  {
    return Arrays.asList(filter(paramIOFileFilter, paramArrayOfFile));
  }
  ...
  public static Set<File> filterSet(IOFileFilter paramIOFileFilter, File[] paramArrayOfFile)
  {
    return new HashSet(Arrays.asList(filter(paramIOFileFilter, paramArrayOfFile)));
  }
  ...
  public static IOFileFilter or(IOFileFilter[] paramArrayOfIOFileFilter)
  {
    return new OrFileFilter(toList(paramArrayOfIOFileFilter));
  }
  ...
  public static List<IOFileFilter> toList(IOFileFilter[] paramArrayOfIOFileFilter)
  {
    if (paramArrayOfIOFileFilter == null)
      throw new IllegalArgumentException("The filters must not be null");
    ArrayList localArrayList = new ArrayList(paramArrayOfIOFileFilter.length);
    for (int i = 0; i < paramArrayOfIOFileFilter.length; i++)
    {
      if (paramArrayOfIOFileFilter[i] == null)
        throw new IllegalArgumentException("The filter[" + i + "] is null");
      localArrayList.add(paramArrayOfIOFileFilter[i]);
    }
