...
public class Element extends BaseObj
{
  ...
  Element(int paramInt1, RenderScript paramRenderScript, DataType paramDataType, DataKind paramDataKind, boolean paramBoolean, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      return;
      this.mSize = (paramInt2 * paramDataType.mSize);
      continue;
  ...
  private void updateVisibleSubElements()
  {
    ...
    if (m < j)
    {
      if (this.mElementNames[m].charAt(0) == '#')
        break label111;
