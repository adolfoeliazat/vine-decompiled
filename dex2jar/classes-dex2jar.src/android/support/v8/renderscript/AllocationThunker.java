...
class AllocationThunker extends Allocation
{
  ...
  {
    switch (1.$SwitchMap$android$support$v8$renderscript$Allocation$MipmapControl[paramMipmapControl.ordinal()])
    {
    default:
      return null;
    case 1:
  ...
  {
    android.renderscript.Allocation localAllocation = android.renderscript.Allocation.createCubemapFromBitmap(((RenderScriptThunker)paramRenderScript).mN, paramBitmap, convertMipmapControl(paramMipmapControl), paramInt);
    return new AllocationThunker(paramRenderScript, new TypeThunker(paramRenderScript, localAllocation.getType()), paramInt, localAllocation);
  }
  ...
  {
    android.renderscript.Allocation localAllocation = android.renderscript.Allocation.createCubemapFromCubeFaces(((RenderScriptThunker)paramRenderScript).mN, paramBitmap1, paramBitmap2, paramBitmap3, paramBitmap4, paramBitmap5, paramBitmap6, convertMipmapControl(paramMipmapControl), paramInt);
    return new AllocationThunker(paramRenderScript, new TypeThunker(paramRenderScript, localAllocation.getType()), paramInt, localAllocation);
  }
  ...
  {
    android.renderscript.Allocation localAllocation = android.renderscript.Allocation.createFromBitmap(((RenderScriptThunker)paramRenderScript).mN, paramBitmap, convertMipmapControl(paramMipmapControl), paramInt);
    return new AllocationThunker(paramRenderScript, new TypeThunker(paramRenderScript, localAllocation.getType()), paramInt, localAllocation);
  }
  ...
  {
    android.renderscript.Allocation localAllocation = android.renderscript.Allocation.createFromBitmapResource(((RenderScriptThunker)paramRenderScript).mN, paramResources, paramInt1, convertMipmapControl(paramMipmapControl), paramInt2);
    return new AllocationThunker(paramRenderScript, new TypeThunker(paramRenderScript, localAllocation.getType()), paramInt2, localAllocation);
  }

  public static Allocation createFromString(RenderScript paramRenderScript, String paramString, int paramInt)
  {
    android.renderscript.Allocation localAllocation = android.renderscript.Allocation.createFromString(((RenderScriptThunker)paramRenderScript).mN, paramString, paramInt);
    return new AllocationThunker(paramRenderScript, new TypeThunker(paramRenderScript, localAllocation.getType()), paramInt, localAllocation);
  }
  ...
  public static Allocation createSized(RenderScript paramRenderScript, Element paramElement, int paramInt1, int paramInt2)
  {
    ...
    ((ElementThunker)paramElement);
    android.renderscript.Allocation localAllocation = android.renderscript.Allocation.createSized(localRenderScriptThunker.mN, (android.renderscript.Element)paramElement.getNObj(), paramInt1, paramInt2);
    return new AllocationThunker(paramRenderScript, new TypeThunker(paramRenderScript, localAllocation.getType()), paramInt2, localAllocation);
  }
  ...
  public void copy1DRangeFrom(int paramInt1, int paramInt2, Allocation paramAllocation, int paramInt3)
  {
    ...
    this.mN.copy1DRangeFrom(paramInt1, paramInt2, localAllocationThunker.mN, paramInt3);
  }
  ...
  {
    AllocationThunker localAllocationThunker = (AllocationThunker)paramAllocation;
    this.mN.copy2DRangeFrom(paramInt1, paramInt2, paramInt3, paramInt4, localAllocationThunker.mN, paramInt5, paramInt6);
  }
  ...
  {
    AllocationThunker localAllocationThunker = (AllocationThunker)paramAllocation;
    this.mN.copyFrom(localAllocationThunker.mN);
  }
  ...
  {
    android.renderscript.FieldPacker localFieldPacker = new android.renderscript.FieldPacker(paramFieldPacker.getData());
    this.mN.setFromFieldPacker(paramInt1, paramInt2, localFieldPacker);
  }

  public void setFromFieldPacker(int paramInt, FieldPacker paramFieldPacker)
  {
    android.renderscript.FieldPacker localFieldPacker = new android.renderscript.FieldPacker(paramFieldPacker.getData());
    this.mN.setFromFieldPacker(paramInt, localFieldPacker);
  }
