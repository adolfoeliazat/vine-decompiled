  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  public ActionMenuView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.mMaxItemHeight = localTypedArray.getDimensionPixelSize(0, 0);
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    while (i13 < i12)
    {
      ...
      else
      {
        ...
        {
          bool2 = true;
          label286: localLayoutParams5.preventEdgeOffset = bool2;
          if (!localLayoutParams5.isOverflowButton)
            break label398;
        }
        label398: for (int i26 = 1; ; i26 = i6)
        {
    ...
    int i22;
    int i23;
    label445: LayoutParams localLayoutParams4;
    if ((i11 != 0) && (i10 == 2))
    {
      i14 = 1;
      i15 = 0;
    ...
    while (true)
    {
      ...
      i14 = 0;
      break;
      label486: if (localLayoutParams4.cellsUsed < i21)
      {
    ...
    while (true)
    {
      ...
      label884: i18 = 0;
      break label709;
      label890: View localView2 = getChildAt(i19);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      label436: i6 = 0;
      break label364;
      label442: int i10 = i8 + localLayoutParams1.leftMargin;
