...
public class DraftViewPager extends ViewGroup
{
  ...
  {
    public int compare(DraftViewPager.ItemInfo paramAnonymousItemInfo1, DraftViewPager.ItemInfo paramAnonymousItemInfo2)
    {
  ...
  public DraftViewPager(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.mDraftMargin = localResources.getDimensionPixelOffset(2131427361);
    initViewPager();
  }
  ...
  void dataSetChanged()
  {
    ...
    int k;
    int m;
    label37: ItemInfo localItemInfo;
    int n;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      if (bool4)
      {
        ...
        int i1 = (int)(getWidth() * this.mPreviewRatio);
        ...
        if (bool3)
        {
          ...
          int m = getWidth() + this.mPageMargin;
          int n = getScrollX();
          setCurrentItemInternal(determineTargetPage(n / (int)(m * this.mPreviewRatio), n % m / m, k, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.mActivePointerId)) - this.mInitialMotionX)), true, true, k);
          this.mActivePointerId = -1;
          endDrag();
    ...
    while (true)
    {
      ...
      if ((!this.mPopulatePending) && (getWindowToken() != null))
      {
        ...
        else
        {
          ...
          localDraftPagerAdapter.setPrimaryItem(this, i4, localObject);
          this.mAdapter.finishUpdate(this);
          if (!hasFocus())
            break;
  ...
  void setCurrentItemInternal(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    label239: if ((bool) && (this.mOnPageChangeListener != null))
      this.mOnPageChangeListener.onPageSelected(paramInt1);
    if ((bool) && (this.mInternalPageChangeListener != null))
      this.mInternalPageChangeListener.onPageSelected(paramInt1);
    completeScroll();
  ...
  public static class SavedState extends View.BaseSavedState
  {
    ...
    {
      public DraftViewPager.SavedState createFromParcel(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
      {
        return new DraftViewPager.SavedState(paramAnonymousParcel, paramAnonymousClassLoader);
      }

      public DraftViewPager.SavedState[] newArray(int paramAnonymousInt)
      {
        return new DraftViewPager.SavedState[paramAnonymousInt];
      }
    });
