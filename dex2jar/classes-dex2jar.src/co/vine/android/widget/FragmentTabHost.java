  ...
  implements TabHost.OnTabChangeListener
{
  ...
  private FragmentTransaction doTabChanged(String paramString, FragmentTransaction paramFragmentTransaction)
  {
    ...
    if (localObject == null)
    {
      CrashUtil.logException(new IllegalStateException("No tab known for tag " + paramString));
    ...
    while (true)
    {
      ...
      return paramFragmentTransaction;
      label203: paramFragmentTransaction.attach(localObject.fragment);
    }
  }
 ...
 * Qualified Name:     co.vine.android.widget.FragmentTabHost
