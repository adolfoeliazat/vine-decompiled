...
.method protected obtainResource(Lco/vine/android/util/image/ImageKey;Ljava/lang/String;Ljava/io/InputStream;)Lco/vine/android/util/image/UrlImage;
    ...
    .prologue
    .line 266
    iget-boolean v6, p1, Lco/vine/android/util/image/ImageKey;->requestResize:Z

    if-eqz v6, :cond_1

    .line 267
    iget v5, p1, Lco/vine/android/util/image/ImageKey;->width:I
    ...
    .local v0, height:I
    :goto_0
    iget-object v6, p0, Lco/vine/android/util/image/PhotoImagesCache;->mContext:Landroid/content/Context;

    invoke-static {v6, p3, v5, v0}, Lco/vine/android/util/image/ImageUtils;->resizeBitmap(Landroid/content/Context;Ljava/io/InputStream;II)Lco/vine/android/util/image/ImageUtils$BitmapInfo;

    move-result-object v6

    invoke-virtual {p0, p1, p2, v6}, Lco/vine/android/util/image/PhotoImagesCache;->instantiateResource(Lco/vine/android/util/image/ImageKey;Ljava/lang/String;Lco/vine/android/util/image/ImageUtils$BitmapInfo;)Lco/vine/android/util/image/UrlImage;
    ...
    .line 275
    const-string v6, "Decoding error!!! Memory Low? Clear all bitmaps now!"
    ...
    .line 278
    .local v3, snapshot:Ljava/util/Collection;,"Ljava/util/Collection<Lco/vine/android/util/image/UrlImage;>;"
    ...
    check-cast v4, Lco/vine/android/util/image/UrlImage;

    .line 280
    .local v4, v:Lco/vine/android/util/image/UrlImage;
    iget-object v6, v4, Lco/vine/android/util/image/UrlImage;->bitmap:Landroid/graphics/Bitmap;
    ...
    iput-object v6, v4, Lco/vine/android/util/image/UrlImage;->bitmap:Landroid/graphics/Bitmap;
    ...
    .end local v3           #snapshot:Ljava/util/Collection;,"Ljava/util/Collection<Lco/vine/android/util/image/UrlImage;>;"
    .end local v4           #v:Lco/vine/android/util/image/UrlImage;
    .end local v5           #width:I
    :cond_1
    iget v5, p0, Lco/vine/android/util/image/PhotoImagesCache;->mMaxImageSize:I
    ...
    .restart local v3       #snapshot:Ljava/util/Collection;,"Ljava/util/Collection<Lco/vine/android/util/image/UrlImage;>;"
    :cond_2
    iget-object v6, p0, Lco/vine/android/util/image/PhotoImagesCache;->mContext:Landroid/content/Context;
